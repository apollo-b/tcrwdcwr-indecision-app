...
console.log(__WEBPACK_IMPORTED_MODULE_1__person_js__["a" /* canDrink */](77));
...
"use strict";
const isAdult = (age) => `A ${age}-year-old isAdult: ${age >= 18 ? "yes" : "no"}`;
/* harmony export (immutable) */ __webpack_exports__["b"] = isAdult;

const canDrink = (age) => `A ${age}-year-old canDrink: ${age >= 21 ? "yes" : "no"}`;
